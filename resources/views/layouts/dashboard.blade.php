            ...
            <div class="col-sm-2">
                ...
                <div class="panel panel-primary">
                    ...
                    <div role="tabpanel" class="panel-collapse collapse" id="colListGroup1" aria-expanded="false">
                        <ul class="list-group">
                            <li class="list-group-item"><a href="{{ route('imoveis.create') }}">Cadastrar</a></li>
                            <li class="list-group-item"><a href="{{ route('imoveis.index') }}">Listar</a></li>
